...
// import { useLoginPageMutation } from "../actions/videosInHomeAc";
...
const LoginPage = () => {
  ...
  const [login, { isLoading, isError }] = useLoginPageMutation({
    username: username,
    password: password,
  });
      ...
      <div className="loginField">
        ...
        <div className="loginInputFildsBtn">
          <div className="inputsWithbtn">
            ...
            <form>
              <input type="checkbox" onClick={handleShowPassToggle} />
              <label>Show password</label>
            </form>
          </div>
          <div className="btnCon">
